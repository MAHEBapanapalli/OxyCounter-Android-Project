...
public class DisplayIncoming extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String qry = "SELECT * FROM " + DatabaseHelper.TABLE_NAME  + " where Type = '" + "Incoming" + "'";

        TextView tableData = findViewById(R.id.display_incoming_textview);
